...
export default function Home() {
  ...
  // Check if current conversation has topics to conditionally apply spacing
  ...
  const hasTopics = currentConversationId && topics.length > 0;
  ...
  return (
    <div className="flex h-screen bg-black relative">
      ...
      <main 
        className={`flex-1 flex flex-col transition-all duration-300 px-4 pt-16 xl:pt-0 ${hasTopics ? 'xl:conversation-index-spacing' : ''}`}
